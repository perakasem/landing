...
{:else}
	{#if windowTooSmall}
		<div
			...
			class="bg-dark serif-warning fixed inset-0 z-50 flex items-center justify-center p-20"
		>
			<p>
				Please adjust your window or rotate your mobile device to provide ample space for the best
				viewing experience.
			</p>
		</div>
	{/if}

	<div class="bg-dark sans-typo flex">
		{@render children()}
	</div>
{/if}
